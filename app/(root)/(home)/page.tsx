  ...
  return (
    <section className="flex size-full flex-col gap-10 text-white">
      <div className="h-[300px] w-full rounded-[20px] bg-hero bg-cover">
        <div className="flex h-full  flex-col justify-end max-md:px-5 max-md:py-8 md:p-11">
          {/* <h2 className="glasmorphism max-w-max px-1 rounded py-2 text-center text-base font-normal"></h2> */}
